...
const FloatingContextBar: React.FC<FloatingContextBarProps> = ({
  ...
  return (
    <div
      className={`pointer-events-auto absolute z-30 flex max-w-[calc(100%-1rem)] items-center gap-1 overflow-x-auto rounded-xl border px-2 py-1 shadow-lg no-scrollbar ${
        isDarkMode
    ...
    >
      ...
      <div className="hidden h-5 w-px bg-slate-300 dark:bg-slate-600 lg:block" />
